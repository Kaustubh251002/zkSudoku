...
export default function Sudoku() {
  ...
  const renderVerifySudoku = () => {
    return (
      <button
        className="flex justify-center items-center disabled:cursor-not-allowed space-x-3 verify-btn text-lg font-medium rounded-md px-5 py-3 w-full bg-red-600 hover:bg-orange-600"
  ...
  const renderVerifySudokuAndMintNft = () => {
    if (!accountQuery.data?.address) {
      return (
        <button
          className="text-lg font-medium rounded-md px-5 py-3 w-full bg-red-600 hover:bg-orange-600"
          onClick={() => {
      ...
      return (
        <button
          className="text-lg font-medium rounded-md px-5 py-3 bg-red-600 hover:bg-orange-600"
          onClick={() => {
            switchNetwork();
          }}
        >
  ...
  return (
    <div>
      ...
      <div className="flex">
        <div className="mx-5 mb-10 text-3xl font-bold text-transparent bg-clip-text bg-red-600 hover:bg-orange-600">
          Sudoku
        </div>
      </div>
