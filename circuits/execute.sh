...
# Copy the input file inside the main_js directory
cp input.json main_js/input.json

# Go inside the main_js directory and generate the witness.wtns
cd main_js
...
snarkjs groth16 setup main.r1cs pot12_final.ptau sudoku_0000.zkey
...
snarkjs zkey export solidityverifier sudoku_0001.zkey verifier.sol
