...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[5]); // line circom 13
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[1];
// load src
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[5]); // line circom 14
while(Fr_isTrue(&expaux[0])){
{
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((9 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 81)]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((9 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 0)]].signalStart + 0]); // line circom 23
...
PFrElement aux_dest = &lvar[0];
// load src
Fr_add(&expaux[0],&lvar[0],&circuitConstants[2]); // line circom 13
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[5]); // line circom 13
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[5]); // line circom 31
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[1];
// load src
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[5]); // line circom 32
while(Fr_isTrue(&expaux[0])){
{
...
Fr_sub(&expaux[2],&circuitConstants[2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((9 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 243)]].signalStart + 0]); // line circom 40
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((9 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 162)]].signalStart + 0],&expaux[2]); // line circom 40
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[5]); // line circom 50
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[2];
// load src
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[5]); // line circom 51
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[3];
// load src
...
Fr_lt(&expaux[0],&lvar[3],&lvar[2]); // line circom 52
while(Fr_isTrue(&expaux[0])){
{
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[0])) + 324)]].signalStart + 0],&circuitConstants[1]); // line circom 56
...
PFrElement aux_dest = &lvar[3];
// load src
Fr_add(&expaux[0],&lvar[3],&circuitConstants[2]); // line circom 52
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[3],&lvar[2]); // line circom 52
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[5]); // line circom 67
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[3];
// load src
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[5]); // line circom 68
while(Fr_isTrue(&expaux[0])){
{
...
Fr_lt(&expaux[0],&lvar[4],&lvar[2]); // line circom 69
while(Fr_isTrue(&expaux[0])){
{
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 648)]].signalStart + 0],&circuitConstants[1]); // line circom 73
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_add(&expaux[0],&lvar[2],&circuitConstants[2]); // line circom 67
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[5]); // line circom 67
...
Fr_lt(&expaux[0],&lvar[4],&circuitConstants[5]); // line circom 84
while(Fr_isTrue(&expaux[0])){
{
...
Fr_add(&expaux[2],&lvar[3],&circuitConstants[6]); // line circom 85
Fr_lt(&expaux[0],&lvar[5],&expaux[2]); // line circom 85
while(Fr_isTrue(&expaux[0])){
{
...
Fr_add(&expaux[2],&lvar[4],&circuitConstants[6]); // line circom 86
Fr_lt(&expaux[0],&lvar[6],&expaux[2]); // line circom 86
while(Fr_isTrue(&expaux[0])){
{
...
Fr_leq(&expaux[0],&lvar[7],&lvar[5]); // line circom 87
while(Fr_isTrue(&expaux[0])){
{
...
Fr_lt(&expaux[0],&lvar[8],&lvar[6]); // line circom 88
while(Fr_isTrue(&expaux[0])){
{
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[2])) + 972)]].signalStart + 0],&circuitConstants[1]); // line circom 92
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_add(&expaux[0],&lvar[2],&circuitConstants[2]); // line circom 93
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[8];
// load src
Fr_add(&expaux[0],&lvar[8],&circuitConstants[2]); // line circom 88
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[8],&lvar[6]); // line circom 88
...
PFrElement aux_dest = &lvar[7];
// load src
Fr_add(&expaux[0],&lvar[7],&circuitConstants[2]); // line circom 87
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_leq(&expaux[0],&lvar[7],&lvar[5]); // line circom 87
...
PFrElement aux_dest = &lvar[6];
// load src
Fr_add(&expaux[0],&lvar[6],&circuitConstants[2]); // line circom 86
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_add(&expaux[2],&lvar[4],&circuitConstants[6]); // line circom 86
...
PFrElement aux_dest = &lvar[4];
// load src
Fr_add(&expaux[0],&lvar[4],&circuitConstants[6]); // line circom 84
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[4],&circuitConstants[5]); // line circom 84
...
PFrElement aux_dest = &lvar[3];
// load src
Fr_add(&expaux[0],&lvar[3],&circuitConstants[6]); // line circom 83
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[5]); // line circom 83
